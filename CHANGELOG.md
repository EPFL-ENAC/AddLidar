...
* add AboutContent component and enhance meta tags for improved SEO and user experience ([0db0259](https://github.com/EPFL-ENAC/AddLidar/commit/0db0259d22eb5c650f85087981a99c09537da1f6))
* add annotation to prevent ArgoCD from pruning dynamically created jobs ([48ce8a4](https://github.com/EPFL-ENAC/AddLidar/commit/48ce8a44145d3546096f706f5232c8e5fd066a29))
* add ArgoCD annotation to prevent auto-pruning of dynamically created jobs ([85da1bc](https://github.com/EPFL-ENAC/AddLidar/commit/85da1bc87fba118cb8997dc447d20875201b6f66))
* add ArgoCD app name determination and update job templates with labels and annotations ([ffc7db2](https://github.com/EPFL-ENAC/AddLidar/commit/ffc7db25ea673a6d6c802d477fc5f77afe492da3))
* add ArgoCD app name determination and update job templates with labels and annotations ([0ccf3c0](https://github.com/EPFL-ENAC/AddLidar/commit/0ccf3c059484f21c2356b15d1f7a9f95322886d6))
* add ArgoCD app name determination and update job templates with labels and annotations ([2490b53](https://github.com/EPFL-ENAC/AddLidar/commit/2490b530dffd7b7797e424244d2f1a3177624d78))
* add auto-filter functionality to MissionListPanel and integrate with HomeView ([e5a1fac](https://github.com/EPFL-ENAC/AddLidar/commit/e5a1fac8b8456d1d6caff301fcc33c265cb8eae1))
* add bottom padding to filter component containers for improved layout ([72c6121](https://github.com/EPFL-ENAC/AddLidar/commit/72c612150d7a1cb34fa6ab3e22e6709569ad9670))
* add check_tiles script to identify coordinate outliers in LAS files ([740b8e1](https://github.com/EPFL-ENAC/AddLidar/commit/740b8e1cef29e0a161c66dc7bd2f25c24a1081e1))
* add classification filters and integrate with point cloud store ([1681e4e](https://github.com/EPFL-ENAC/AddLidar/commit/1681e4eeb5c11c373bec934a1e0a2409eba1d0db))
* add development, build, and test commands to Makefiles for backend and frontend ([459a2a0](https://github.com/EPFL-ENAC/AddLidar/commit/459a2a0f84215f8bb5aedb2db7445628a0b37fec))
* add favicon support ([989bcbc](https://github.com/EPFL-ENAC/AddLidar/commit/989bcbc224422d5e00f53e50da6ca82f3b758100))
* add handling for empty folders in directory scanner ([71e0da8](https://github.com/EPFL-ENAC/AddLidar/commit/71e0da80f9b12d3f7cbcebdeabb16dc533ec2735))
* add in-cluster and local kubeconfig loading for pod log collector ([57f0122](https://github.com/EPFL-ENAC/AddLidar/commit/57f0122039a6a1fc09888f80229c1f7f8fceb7ba))
* add left drawer toggle functionality ([103674d](https://github.com/EPFL-ENAC/AddLidar/commit/103674ddf13235f0799b2bbeb32fa618a2532b3a))
* add MissionExpandedDetails component ([4425d49](https://github.com/EPFL-ENAC/AddLidar/commit/4425d49bf3ee46a3caa0e08dd6e45cb43817c5c5))
* add MissionInfoPanel for detailed mission statistics and metadata display ([ee045f6](https://github.com/EPFL-ENAC/AddLidar/commit/ee045f61b111e560c74bae7a7e0819e93d668ef1))
* add point cloud metadata file and enhance classification filter UI with color selection ([7e89278](https://github.com/EPFL-ENAC/AddLidar/commit/7e892788cdc9b3669ae747d6bd601c8e90b2a79e))
* add progress bar and detailed job statistics including ETA and speed tracking ([5fdd25d](https://github.com/EPFL-ENAC/AddLidar/commit/5fdd25d58b1c701cd02e5f7d357b2422dc4f57aa))
* add range labels to AttributeRangeFilter for improved user feedback ([2ccd794](https://github.com/EPFL-ENAC/AddLidar/commit/2ccd7941e7e3f485a478a1fb79e6ff3ec61556e4))
* add Roboto font import for improved typography in the application ([ee06bf7](https://github.com/EPFL-ENAC/AddLidar/commit/ee06bf7bfcc4800ad31518db3e67e5f927ed725c))
* add tooltips to tabs in ViewerSidebar and improve layout in ExportPanel ([b4ec745](https://github.com/EPFL-ENAC/AddLidar/commit/b4ec745fce0efd8edd9cc7de8157cb1c87b7dd1a))
* add TypeScript declaration for Vue components ([fe7fa60](https://github.com/EPFL-ENAC/AddLidar/commit/fe7fa60d4e0e9b1905dae82fef8191c021c475c2))
* add UI/UX guidelines document to enhance design consistency ([8efbe0b](https://github.com/EPFL-ENAC/AddLidar/commit/8efbe0b0709fb14830e478ae016398229019ab2e))
* add visible missions tracking and separator in MissionListPanel ([3c4f815](https://github.com/EPFL-ENAC/AddLidar/commit/3c4f81500dc51ad6513589f9368aaa9d376dec6c))
* **backend:** enhance lidardatamanager job definition with labels for ArgoCD tracking ([177c13d](https://github.com/EPFL-ENAC/AddLidar/commit/177c13d4531a0c69313719ace2df5f714fd1c938))
* capitalize attribute labels in ColorVariableSelector for improved readability ([b67c51d](https://github.com/EPFL-ENAC/AddLidar/commit/b67c51db436d65b037b7c3b28abf796061353cf2))
* capture logs for added pods to handle quick failures ([330368b](https://github.com/EPFL-ENAC/AddLidar/commit/330368bc9151288f42820186255ef7137e8b56ef))
* enhance AboutContent and MainAppLayout for improved UI and scrollbar styling ([2a81731](https://github.com/EPFL-ENAC/AddLidar/commit/2a81731fc03dd56b1de7e62732a07845ffb5d130))
* enhance ClipVolume and ExportPanel with improved styling and layout adjustments ([d693b8b](https://github.com/EPFL-ENAC/AddLidar/commit/d693b8bab292ecb70de9632baef06173f64cdd25))
* enhance coreutils installation process with error handling and feedback ([4f4e1c3](https://github.com/EPFL-ENAC/AddLidar/commit/4f4e1c340325d32b9605aee4e8ae1db524e91000))
* enhance ExportPanel with additional parameters for density, color removal, and line indexing ([725a64b](https://github.com/EPFL-ENAC/AddLidar/commit/725a64b8d762a4b413e01191b7faeeca35484666))
* enhance FilesPanel with download button and improved layout for file items ([26a17ab](https://github.com/EPFL-ENAC/AddLidar/commit/26a17ab2eb687f155dbd707aeeb1125b793ab28b))
* enhance FilesPanel with sortable columns and improved file display ([9027bd0](https://github.com/EPFL-ENAC/AddLidar/commit/9027bd0745dc9002aaa8b79c7aa688189a269658))
* enhance job log streaming with progress tracking and ETA calculation ([1b83afb](https://github.com/EPFL-ENAC/AddLidar/commit/1b83afbace651acd2de772d6a7b6b560ef351c9c))
* enhance left drawer layout and toggle button functionality ([69b1821](https://github.com/EPFL-ENAC/AddLidar/commit/69b182125ea7d481da4ca56ecae40ea84b3440bb))
* enhance log streaming by waiting for pod readiness before starting log polling ([f7591cb](https://github.com/EPFL-ENAC/AddLidar/commit/f7591cb0b04a6d6b562343037a5e98733acf9e9c))
* enhance log streaming with detailed debug logging for progress updates ([83efc56](https://github.com/EPFL-ENAC/AddLidar/commit/83efc56959510ea4cebf6aa84da03ad8700bdca7))
* enhance mission hover functionality and styling in MissionListPanel and MissionFootprintMap ([b9f22d4](https://github.com/EPFL-ENAC/AddLidar/commit/b9f22d47e6e2e03c44e824c11fcb078010bbf0c1))
* enhance MissionCard and directoryStore with additional attributes and improved UI ([5a301fd](https://github.com/EPFL-ENAC/AddLidar/commit/5a301fd0f6bfcf13f760b22ecd58bbdc8babdafb))
* enhance MissionFootprintMap and MissionCard  - hover functionality - improved UI elements ([e3c58fb](https://github.com/EPFL-ENAC/AddLidar/commit/e3c58fbe91c1345b66a434b3b9eb0cb314df54ce))
* enhance MissionFootprintMap interactivity ([4254040](https://github.com/EPFL-ENAC/AddLidar/commit/4254040a8514b6f7050a252b26f900ef5c63eb01))
* enhance MissionFootprintMap interactivity - improve hover effects and color variations ([99be1a9](https://github.com/EPFL-ENAC/AddLidar/commit/99be1a99c744bd16a579a8d9006462f28274d1a6))
* enhance MissionInfoPanel with improved layout and styling for better readability ([15f07e4](https://github.com/EPFL-ENAC/AddLidar/commit/15f07e49efe4c8905a84cc05e5ef3eaf9ee7285f))
* enhance MissionListPanel UI with improved styling and interactivity ([c2d9998](https://github.com/EPFL-ENAC/AddLidar/commit/c2d9998b0ed18863c7bf1941ebb9806b5a53e639))
* enhance MissionListPanel with sticky header and improved styling ([013c8c9](https://github.com/EPFL-ENAC/AddLidar/commit/013c8c9752745fa89f05256453e7f4fcfa1b24f0))
* enhance pod log capturing with deletion metadata and retry logic ([4d3b0d3](https://github.com/EPFL-ENAC/AddLidar/commit/4d3b0d3d5edca4f1d1a48f8e7183d2089aab3cdd))
* enhance pod log details ([fffe51d](https://github.com/EPFL-ENAC/AddLidar/commit/fffe51d14d243f375747dff4634433b18f0475d3))
* enhance potree metacloud state with additional attributes and parsing support ([ccf61ae](https://github.com/EPFL-ENAC/AddLidar/commit/ccf61ae9581eb8a11caec62b8b2b9e5dc5c0ba47))
* enhance real-time log streaming with unbuffered output settings ([0e711b8](https://github.com/EPFL-ENAC/AddLidar/commit/0e711b8a1a19f9a04bd7c3cc902a0be13f720726))
* enhance ROI logging and parameter handling in job submission ([31e9197](https://github.com/EPFL-ENAC/AddLidar/commit/31e919765e4ba94a34a1c62b27e003a740b38dee))
* enhance ViewerView with mission name display and improved layout ([904b52a](https://github.com/EPFL-ENAC/AddLidar/commit/904b52a16e9d7f84c1826330ca1658df929d809a))
* extend PotreeMetacloudStateUpdate and APIClient to support additional attributes ([461c98c](https://github.com/EPFL-ENAC/AddLidar/commit/461c98cceedde5bc2e2a5dc6c809c375a0629d24))
* **frontend:** refactor UI components and simplify styling ([d922f1b](https://github.com/EPFL-ENAC/AddLidar/commit/d922f1be94dcfaae18f7810c59faab4a893c2f68))
* **frontend:** refactor UI to have a harmonized app ([b6b5343](https://github.com/EPFL-ENAC/AddLidar/commit/b6b53437c42a89bbb3098f27b2f6c211dc56dd80))
* implement attribute range filters and integrate into point cloud viewer ([8d2d1a5](https://github.com/EPFL-ENAC/AddLidar/commit/8d2d1a554ab64d9be4ab834ff331a3fd711c2e73))
* implement hidden missions functionality in MissionFootprintMap and MissionListPanel components ([0f37501](https://github.com/EPFL-ENAC/AddLidar/commit/0f37501698c41e2f855be5809765d2183c6f51c6))
* implement job history management ([1ddcf38](https://github.com/EPFL-ENAC/AddLidar/commit/1ddcf384ccf114eab90117e8abf01b4f55465a35))
* implement MissionListPanel component to enhance mission selection UI ([f0fe9b8](https://github.com/EPFL-ENAC/AddLidar/commit/f0fe9b89c768a95e45d218d8a0edefe18bf8eb5d))
* implement pod log API routes and collector service for capturing pod logs ([8691a0a](https://github.com/EPFL-ENAC/AddLidar/commit/8691a0add1ddb3ff67239e42ed1d600322bed7c7))
* import quasar flex addon ([4da2b3a](https://github.com/EPFL-ENAC/AddLidar/commit/4da2b3a3d3da21e97fa9721cc300ddaef4b0d55b))
* improve log streaming by implementing polling with timeout to enhance responsiveness ([869f220](https://github.com/EPFL-ENAC/AddLidar/commit/869f220a36f3a1e1af6a58e1b85f727d1ecbf5a5))
* improve log streaming responsiveness and add support for unbuffered output ([1470e27](https://github.com/EPFL-ENAC/AddLidar/commit/1470e27eaadee6126643aeb8efd0d3efea64e6a4))
* increase resource requests and limits for pod compression and potree conversion jobs ([e400f54](https://github.com/EPFL-ENAC/AddLidar/commit/e400f5497330b0ebd0d5266a328efd0e9ac0b87a))
* integrate ColorVariableSelector component into DisplayPanel for improved color mode selection ([df261fa](https://github.com/EPFL-ENAC/AddLidar/commit/df261fa67ed5a663bbb6a3cb4e52b0cd56bd6ac3))
* integrate JobsPanel into ExportPanel and update ViewerSidebar to remove jobs tab ([b371b01](https://github.com/EPFL-ENAC/AddLidar/commit/b371b0174d711e2f43f91c114c8ceb38d75fc62b))
* refactor attributeOptions to include default color option for better clarity ([340371c](https://github.com/EPFL-ENAC/AddLidar/commit/340371cde98c317fef51721261db739c08db68d2))
* refactor layout structure to use MainAppLayout and streamline UI components ([6d08689](https://github.com/EPFL-ENAC/AddLidar/commit/6d08689e33b088106b39ad7b2c806f7abcec2cbc))
* refactor MissionListPanel and MainAppLayout for improved UI responsiveness and styling ([2a2504d](https://github.com/EPFL-ENAC/AddLidar/commit/2a2504d5cfd2eab1a1344ce598e7955e4532f3f7))
* refactor point cloud handling to use export job store and improve metadata management ([37fea38](https://github.com/EPFL-ENAC/AddLidar/commit/37fea3873ede296f894ad1ed70870aff5f6c9c8e))
* refactor UI layout by integrating AppToolbar and adding EPFL logo ([7c621ee](https://github.com/EPFL-ENAC/AddLidar/commit/7c621ee176f7b508f2e963f27d691f2cc83383ed))
* refine layout styling in MainAppLayout and remove unnecessary header attributes ([73d90e5](https://github.com/EPFL-ENAC/AddLidar/commit/73d90e5aa8e33ae1bd7121db60bef67502138cfa))
* remove AppToolbar component ([7815ed0](https://github.com/EPFL-ENAC/AddLidar/commit/7815ed010a91b16f337ef4300aa725d9253e1a1e))
* remove deprecated VisualFilters component ([eac3d2f](https://github.com/EPFL-ENAC/AddLidar/commit/eac3d2f5bdfc5cc8d86f2320a24718468d9f5290))
* replace AppearancePanel with DisplayPanel and update tab structure in ViewerSidebar ([136af8b](https://github.com/EPFL-ENAC/AddLidar/commit/136af8bcd6fe01181d063d6f5b39b5db4de2e1ed))
* set memory limit for potree converter job ([5cfddd2](https://github.com/EPFL-ENAC/AddLidar/commit/5cfddd2580d212e560124b1bfedf1bca5dafe90f))
* update AboutContent layout and styling for improved readability ([d90e99f](https://github.com/EPFL-ENAC/AddLidar/commit/d90e99f8e7d81077d06c8733048c0f7b645a59bd))
* update component labels for clarity and consistency ([c38ceb4](https://github.com/EPFL-ENAC/AddLidar/commit/c38ceb461764bc0106157219b58120906c991cea))
* update date format support in metacloud parser ([384e458](https://github.com/EPFL-ENAC/AddLidar/commit/384e458f74dd0d566f85ea907e88e3c5fbd6661c))
* update Dockerfile and package.json to support Gulp tasks with new gulpfile ([65ae891](https://github.com/EPFL-ENAC/AddLidar/commit/65ae891d29a2dd8d11e631cb179004076661a5ab))
* update job terminology to export and add job name formatting utility ([0b2634a](https://github.com/EPFL-ENAC/AddLidar/commit/0b2634a693068b58bba8b4f7961d8199974dcedb))
* update package.json scripts for local development and enhance Vite proxy configuration ([19861a2](https://github.com/EPFL-ENAC/AddLidar/commit/19861a222efc2d385e3da6f6651861de0c392a25))
* update positive color variable and remove About route from router ([9b5d2b9](https://github.com/EPFL-ENAC/AddLidar/commit/9b5d2b92fc4be651d58d180840d763b7da59f9bd))
* update resource requests and limits for Lidar jobs using environment variables ([c437f0d](https://github.com/EPFL-ENAC/AddLidar/commit/c437f0dea39c19a2eff6e10d1dc1a3c999946643))
* update start_log_streaming to accept event loop for async operations ([8a54474](https://github.com/EPFL-ENAC/AddLidar/commit/8a54474dab76afe1791eb2de147ab74b1d7b4b3f))
* update ViewerView to set app meta title based on mission name ([43dbda8](https://github.com/EPFL-ENAC/AddLidar/commit/43dbda8f42b2f59e0a2912632b80315d4c336655))
* use 'rgba' default & improve logs ([97cae4a](https://github.com/EPFL-ENAC/AddLidar/commit/97cae4afdfebe30fb5ae7a3a51f95284f31928f1))


### Bug Fixes

* add debug logging for pod log collector startup ([2347d47](https://github.com/EPFL-ENAC/AddLidar/commit/2347d471e825bc521da747f5cdaad4e9f07745ba))
* add workspace configuration and update job templates with metadata labels ([9668442](https://github.com/EPFL-ENAC/AddLidar/commit/96684426faf18146718a09cea720cbea03e3408c))
* correct PotreeConverter directory name in Dockerfile ([58fd129](https://github.com/EPFL-ENAC/AddLidar/commit/58fd129d575a0015b663d8ca09886dc3ea2816ca))
* improve pod log collector startup reliability ([df4e1f5](https://github.com/EPFL-ENAC/AddLidar/commit/df4e1f5e68806e2ccdb42be68eb107ea2365c9f2))
* update application name for ArgoCD annotations based on environment ([a7eb042](https://github.com/EPFL-ENAC/AddLidar/commit/a7eb042fa1c0a8f88486a99911b38cca32534638))
* update Dockerfile and scripts to include missing dependencies for YAML and Jinja2 ([f766e60](https://github.com/EPFL-ENAC/AddLidar/commit/f766e60f695202f8f54b01535a5615921a4fb770))
* update Dockerfile and scripts to include missing dependencies for YAML and Jinja2 ([66465e7](https://github.com/EPFL-ENAC/AddLidar/commit/66465e7fa889487a552965c84215a08b94926c80))
* update job TTL settings to retain logs for 24 hours in compression and potree conversion jobs ([557cb63](https://github.com/EPFL-ENAC/AddLidar/commit/557cb63d8cbb58f035813a179f9acb3a4957029c))
* wrap content of log container to avoid x overflow ([c07b824](https://github.com/EPFL-ENAC/AddLidar/commit/c07b82497bf0b5302bf195916e0d1d4060b93629))
...
* **scanner:** increase memory limit for potree-converter to 22Gi ([30d7f6f](https://github.com/EPFL-ENAC/AddLidar/commit/30d7f6fa01e8777ee626c6202c81b771b917b9ac))

## [0.7.3](https://github.com/EPFL-ENAC/AddLidar/compare/v0.7.2...v0.7.3) (2025-06-30)


### Bug Fixes

* **scanner:** reduce memory limit for potree-converter from 12Gi to 1Gi ([5c7480d](https://github.com/EPFL-ENAC/AddLidar/commit/5c7480da8063233518d8002a4ccd2e0c2bbd2b13))
